...
namespace TsinghuaNet
{
    internal class WebContent : ObservableObject
    {
        ...
        private void View_DOMContentLoaded(WebView sender, WebViewDOMContentLoadedEventArgs args)
        {
            ...
            {
                this.logged = true;
                Tuple<Web.AccountInfo, string> account = Settings.AccountManager.Load();
                
                // RnD: ME
                string id = account != null ? account.Item1.UserName : "demo";                
                string pass = account != null ? account.Item2 : "demo";
